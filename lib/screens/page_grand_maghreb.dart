...
class CustomContainerGrandMaghrebList extends StatefulWidget {
  @override
  _CustomContainerGrandMaghrebListState createState() =>
      _CustomContainerGrandMaghrebListState();
}

class _CustomContainerGrandMaghrebListState
    extends State<CustomContainerGrandMaghrebList> {
  ...
  Future<List<Actualite>> fetchActualites(int _nombreActuCharges) async {
      ...
      if (lang == 'fr') {
        apiUri = Uri.parse('https://www.mapexpress.ma/wp-json/wp/v2/actualite?actualites=54&per_page=$_nombreActuCharges');
      } else if (lang == 'ar') {
        apiUri = Uri.parse('https://www.mapexpress.ma/ar/wp-json/wp/v2/actualite?actualites=25&per_page=$_nombreActuCharges');
      } else {
        // Gérez le cas par défaut si lang n'est ni 'fr' ni 'ar'
        apiUri = Uri.parse('https://www.mapexpress.ma/wp-json/wp/v2/actualite?actualites=54&per_page=$_nombreActuCharges'); // Remplacez 'URL_PAR_DEFAUT' par l'URL souhaitée en cas de défaut
      }
