...
class CustomContainerMondesList extends StatefulWidget {
  @override
  _CustomContainerMondesListState createState() =>
      _CustomContainerMondesListState();
}

class _CustomContainerMondesListState extends State<CustomContainerMondesList> {
  ...
  Future<List<Actualite>> fetchActualites(int _nombreActuCharges) async {
      ...
      if (lang == 'fr') {
        apiUri = Uri.parse('https://www.mapexpress.ma/wp-json/wp/v2/actualite?actualites=53&per_page=$_nombreActuCharges');
      } else if (lang == 'ar') {
        ...
        apiUri = Uri.parse('https://www.mapexpress.ma/wp-json/wp/v2/actualite?actualites=53&per_page=$_nombreActuCharges'); // Remplacez 'URL_PAR_DEFAUT' par l'URL souhaitée en cas de défaut
      }
