...
class CustomContainerSocietes extends StatefulWidget {
  @override
  _CustomContainerSocietesState createState() =>
      _CustomContainerSocietesState();
}

class _CustomContainerSocietesState extends State<CustomContainerSocietes> {
  ...
  Future<List<Actualite>> fetchActualites() async {
      ...
      if (lang == 'fr') {
        apiUri = Uri.parse('https://www.mapexpress.ma/wp-json/wp/v2/actualite?actualites=24&per_page=1');
      } else if (lang == 'ar') {
        ...
        apiUri = Uri.parse('https://www.mapexpress.ma/wp-json/wp/v2/actualite?actualites=24&per_page=1'); // Remplacez 'URL_PAR_DEFAUT' par l'URL souhaitée en cas de défaut
      }
              ...
              child: Column(
                ...
                children: <Widget>[
                    Row(
                      ...
                      children: [
                        Text(
                          lang == 'fr' ? 'Société et Région' : 'المجتمع والمنطقة',
                          style: TextStyle(
                            fontSize: 20,
